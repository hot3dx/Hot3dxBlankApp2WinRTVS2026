...
namespace winrt::Hot3dxBlankApp2::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Scenario2_base : implements<D, Hot3dxBlankApp2::Scenario2, composing, winrt::Windows::UI::Xaml::Controls::IPageOverrides, winrt::Windows::UI::Xaml::Controls::IControlOverrides, winrt::Windows::UI::Xaml::Controls::IControlOverrides6, winrt::Windows::UI::Xaml::IFrameworkElementOverrides, winrt::Windows::UI::Xaml::IFrameworkElementOverrides2, winrt::Windows::UI::Xaml::IUIElementOverrides, winrt::Windows::UI::Xaml::IUIElementOverrides7, winrt::Windows::UI::Xaml::IUIElementOverrides8, winrt::Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = Scenario2_base;
        using class_type = Hot3dxBlankApp2::Scenario2;
        using implements_type = typename Scenario2_base::implements_type;
        ...
        {
            return L"Hot3dxBlankApp2.Scenario2";
        }
        Scenario2_base()
        {
...
namespace winrt::Hot3dxBlankApp2::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Scenario2T : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = Hot3dxBlankApp2::Scenario2;
...
#if defined(WINRT_FORCE_INCLUDE_SCENARIO2_XAML_G_H) || __has_include("Scenario2.xaml.g.h")

#include "Scenario2.xaml.g.h"
...
{
    template <typename D, typename... I>
    using Scenario2T = Scenario2_base<D, I...>;
}
