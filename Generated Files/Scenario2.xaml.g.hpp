...
namespace winrt::Hot3dxBlankApp2::implementation
{
    ...
    void Scenario2T<D, I...>::InitializeComponent()
    {
        if (!_contentLoaded)
        {
            _contentLoaded = true;
            Uri resourceLocator{ L"ms-appx:///Scenario2.xaml" };
    ...
    template <typename D, typename ... I>
    void Scenario2T<D, I...>::DisconnectUnloadedObject(int32_t)
    {
        throw ::winrt::hresult_invalid_argument { L"No unloadable objects to disconnect." };
    }

    template <typename D, typename ... I>
    void Scenario2T<D, I...>::UnloadObject(DependencyObject const&)
    {
    ...
    template <typename D, typename... I>
    IComponentConnector Scenario2T<D, I...>::GetBindingConnector(int32_t, IInspectable const&)
    {
        return nullptr;
    }

    template struct Scenario2T<struct Scenario2>;
}
